...
{
    QFile file(":/txt_files/NameMatrix.txt");
...
void Planet::Plant()
{
    plant_pixel_count=0;
    QImage diagram;
    if (s.is_gradient) diagram=QImage(":/images/plantmatrixblur.png");
    else diagram=QImage(":/images/plantmatrix.png");
    for (int i=0;i<world_size;i++)
    {
        for (int k=0;k<world_size;k++)
        {
...
{
    img_dsc=QImage(":/images/window.png");
...
{
    img_sys=QImage(":/images/window.png");
    QPainter p;
    p.begin(&img_sys);
    int r;
    r=RAND(4,8);
...
{
    QImage img_ptr=QImage(":/images/icon ptr.png");
    QImage img_map=QImage(":/images/GalaxyMap.png");
    img_gal=QImage(":/images/window.png");
    int x=RAND(0,218);
    int y=RAND(0,218);
...
void Planet::FinalImage()
{
    ...
    QImage img_window=QImage(":/images/window.png");
    QPainter p;
    p.begin(&img_final);
