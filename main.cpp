 ...
 * [bug] не работает детализация облаков
 * fault formation
 * размытие карты биомов
 * градиентное окрашивание (вкл/выкл) (вода, суша, ледники, растения, кольца)
 * освещение колец должно зависеть от точки освещения?
 * [?] разделить градиенты воды и суши
 * масштабирование структуры по Земле
 * шум пикселей
 * переменное количество точек окрашивания
 * пересмотреть изменения при изменении планеты
 * заменить "жизнь" на другую характеристику в описании
*/
