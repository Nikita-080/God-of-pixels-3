 ...
 * [ok] [bug] максимальный уровень льда недоходит до границы прогрессбара <- лед не покрывает периметр мира
 * [ok] добавить новые уровни в разделе description
 * тектоническая симуляция
 * кратеры
 * молнии
 * резервироание и восстановление после ошибки
*/
