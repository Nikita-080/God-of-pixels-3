    ...
    , ui(new Ui::MainWindow)
{
    ...
    for (int i=0;i<10;i++){
        ui->tabWidget->setTabIcon(i,QIcon(":/images/TabIcon"+QString::number(i+1)+".png"));
    }
    ...
    s.Load(":/txt_files/settingsbase.txt"); //protected
    Settings_Set();
...
void MainWindow::SetStyle()
{
    ...
    QString sliderstyle=ReadText(":/css_files/slider.css");
    QString menubarstyle=ReadText(":/css_files/menubar.css");
    QString tabwidgetstyle=ReadText(":/css_files/tabwidget.css");
    QString buttonstyle=ReadText(":/css_files/button.css");
    QString comboboxstyle=ReadText(":/css_files/combobox.css");
    QString progressbarstyle=ReadText(":/css_files/progressbar.css");
    ...
    ui->pushButton_8->setIcon(QIcon(":/images/logo.png"));
}
...
void MainWindow::M_Load_Base_Settings(){
    Settings_Get(); //для начального заполнения "буфера" настроек
    if (s.Load(":/txt_files/settingsbase.txt"))
    {
        Settings_Set();
    }
